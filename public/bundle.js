...
var _Screen = __webpack_require__(28);
...
var Calculator = function (_React$Component) {
  ...
  function Calculator() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Calculator.__proto__ || Object.getPrototypeOf(Calculator)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return result;
    }, _this.fixRoundingErrors = function (result) {
      result = String(result);
      if (result.slice(9, 15) === '000000') {
        var endOfZeroes = void 0;
        for (var i = 15; i > 0; i--) {
        ...
        var endOfNines = void 0;
        for (var _i = 15; _i > 0; _i--) {
          if (result[_i] !== '9' && !endOfNines) {
            endOfNines = _i;
          }
        }
  ...
  _createClass(Calculator, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Buttons2.default, { handlePowerButtonPress: this.handlePowerButtonPress,
...
exports.default = function (props) {
  return _react2.default.createElement(
    'div',
    { id: 'buttons' },
    _react2.default.createElement(_Button2.default, { click: props.handlePowerButtonPress,
      buttonColour: 'black-button',
      buttonValue: 'ON/OFF',
      buttonID: 'on-off-button-text'
    }),
    _react2.default.createElement(_Button2.default, { click: props.handleClearAll,
